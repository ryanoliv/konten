      ...
      <div className="flex flex-col gap-12 legal-container">
        ...
        <div className="flex flex-col gap-2">
          ...
          <p className="legal-subtitle">
            ...
            who are involved in the delivery of products or services to you. We
            have agreements in place to ensure that they comply with the privacy
            requirements as required by the Protection of Personal Information
            Act.
          </p>
          <ul className="legal-list">
        ...
        <div className="flex flex-col gap-2">
          ...
          <p className="legal-subtitle">
            ...
            personal information we hold and to stop unauthorized access and use
            of personal information. We will, on an on-going basis, continue to
            review our security controls and related processes to ensure that
          ...
          <p className="legal-subtitle">
            ...
            privacy and confidentiality obligations on them to ensure that
            personal information that we remain responsible for, is kept secure.
            We will ensure that anyone to whom we pass your personal information
            agrees to treat your information with the same level of protection
            as we are obliged to.
          </p>
        </div>
        <div className="flex flex-col gap-2">
          ...
          <p className="legal-subtitle">
            ...
            hold about you. To do this, simply contact us at the
            numbers/addresses as provided on our website and specify what
            information you require. We will need a copy of your ID document to
            confirm your identity before providing details of your personal
        ...
        <div className="flex flex-col gap-2">
          ...
          <p className="legal-subtitle">
            ...
            personal information. We will require a copy of your ID document to
            confirm your identity before making changes to personal information
            we may hold about you. We would appreciate it if you would keep your
        ...
        <div className="flex flex-col gap-2">
          ...
          <p className="legal-subtitle">
            ...
            Further to the POPI Act, COR Concepts also includes the following
        ...
        <div className="flex flex-col gap-2">
          ...
          <p className="legal-subtitle">
            ...
            exercise preferences or access or correct your personal information,

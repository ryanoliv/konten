      ...
      <div className="flex flex-col gap-12 legal-container">
        ...
        <div className="flex flex-col gap-2">
          ...
          <p className="legal-subtitle">
            ...
            including but not limited to user experience design, user interface
            design, web development, app development, and SEO services.
          </p>
        </div>
        <div className="flex flex-col gap-2">
        ...
        <div className="flex flex-col gap-2">
          ...
          <p className="legal-subtitle">
            All intellectual property rights in the services provided, including
            but not limited to software, documentation, and design, are owned by
            Konten or its licensors. Users are granted a non-exclusive,
            non-transferable license to use the products or services provided by
            Konten solely for their intended purpose.
          </p>
        </div>
        <div className="flex flex-col gap-2">
